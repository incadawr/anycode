...
export interface RunCodexDoctorOptions {
   ...
   */
  signal?: AbortSignal;
  /** DI seam for the spawn-time trust gate; production re-reads the real filesystem (`classifyCodexBinaryPathTrust`). */
  trust?: (binaryPath: string) => CodexBinaryTrustGateOutcome;
