...
describe("automation facade — provider connections grid/drawer probe/driver (TASK.45 W12)", () => {
  ...
  function drawerState(overrides: Partial<ProviderDrawerDomState> = {}): ProviderDrawerDomState {
    return {
      ...
      maxOutputTokensPresets: [
        ...
        { label: "8192", selected: false },
        { label: "16384", selected: false },
        { label: "32768", selected: false },
  ...
  function fakeProviderPaneDom(
    ...
    return {
      ...
      setDrawerMaxOutputTokens: vi.fn<(value: string) => boolean>(() => true),
      clickDrawerMaxOutputPreset: vi.fn<(label: string) => boolean>(() => true),
